...
func (m *CopyrightTxRequest) GetSessionID() string {
	if m != nil {
		return m.SessionID
	}
	return ""
...
func (m *CopyrightTxRequest) GetWorkID() string {
	if m != nil {
		return m.WorkID
	}
	return ""
...
func (m *CopyrightTxRequest) GetFrom() string {
	if m != nil {
		return m.From
	}
	return ""
...
func (m *CopyrightTxRequest) GetTo() string {
	if m != nil {
		return m.To
	}
	return ""
